...
param HubSubnet2Name string = 'GatewaySubnet'
...
module CloudNetworkGateway 'cloudvpn.template.bicep' = {
  scope:rg
  name: 'azurevpngateway'
  params:{
    vnetName: vnets.outputs.hubVnetName
    publicIPAddresses_azurevpnpubip_name:'azurevpnpubip'
    vpngwLocation:location
  //  azurevpnvnet_name_GatewaySubnet: vnets.outputs.azurevpnvnet_GatewaySubnetID
   //virtualNetworkGateways_azurevpngw_name: 'GatewaySubnet'
   virtualNetworkGateways_azurevpngw_name: 'azurevpngw'
  }
}


module onPremConnection 'onpremconnection.template.bicep' = {
  scope:rg
  name: 'OnPremconnection'
  params:{
    location: location
    LocalNetworkGateway_id: 'azurevpngw'
    VirtualNetworkGateway_id: 'Gateway-OnPrem'
    connections_azureonpremconnection_name: 'onpremtoazure'
    gatewayResourceGroupName: 'OnPremisesVNET'
    gatewaySubscriptionId: '5726c027-4022-49e6-87bf-01cb66e8fd6b'
  }
